...
export function CampaignCard({ campaign, index = 0 }: CampaignCardProps) {
 ...
 <Badge className="bg-[#CDF88D] text-[#14532d] hover:bg-[#CDF88D]">
 {campaign.category}
 </Badge>
 </div>
 {campaign.trending && (
 ...
 <h3 className="line-clamp-2 text-base font-semibold transition-colors group-hover:text-[#CDF88D]">
 {campaign.title}
 </h3>
 ...
 <span className="font-medium text-[#CDF88D]">{progress}%</span>
 </div>
