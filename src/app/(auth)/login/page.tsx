...
function LoginFormComponent() {
 ...
 <div className="mt-4 rounded-lg border border-dashed border-[#22c55e]/30 bg-[#22c55e]/5 p-3">
 <p className="text-xs font-medium text-[#22c55e]">Demo Accounts</p>
 <div className="mt-1 space-y-1 text-xs text-muted-foreground">
 <p><span className="font-medium text-foreground">Admin:</span> admin@fundrise.com / admin123</p>
 <p><span className="font-medium text-foreground">User:</span> user@fundrise.com / user123</p>
 </div>
 </div>
 </form>
